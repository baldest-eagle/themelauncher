...
KNOWN_COMPONENT_TYPES = {
    ...
    "mica", "oldnewexplorer", "resource_redirect", "icons",
}
...
FOLDER_COMPONENT_TYPES = {
    "cursors", "windhawk", "terminal", "firefox", "resource_redirect",
}
    ...
    def _validate(self, data: dict) -> None:
        ...
        for comp_type, comp_data in components.items():
            ...
            # Folder-based components should have a "path" key
                ...
                if "path" not in comp_data and comp_type != "terminal" and comp_type != "firefox":
                    log.warning(
